...
export default function MarriageCertificate({ user, show, setShow }) {
        ...
        <div>
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <p className='text-center'>Dated this <u>{moment(user.marriageInfo.createdAt).format('DD MMMM YYYY')}</u></p>
                </Modal.Body>
            </Modal>
        </div>
    )
